...
const meta = {
  title: 'Grid/Doubled Grid',
  tags: ['autodocs'],
} satisfies Meta<DoubledGridArgs>;

export default meta;
type Story = StoryObj<DoubledGridArgs>;
...
export const FlatTop: Story = {
  ...
  argTypes: {
    orientation: {
      ...
      labels: {
        'pointy-top': 'Pointy Top (Doubled-Width)',
        'flat-top': 'Flat Top (Doubled-Height)',
      },
    },
    gap: {
  ...
  render: (args) => {
    ...
    container.style.cssText = `
      ...
      background: #f0f0f0;
    `;
    container.className = `doubled-grid ${args.orientation}`;
